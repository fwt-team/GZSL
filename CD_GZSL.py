...
parser.add_argument('--dataset', default='AWA2', help=' ')
...
if opt.dataset == 'CUB':
    ...
    opt.nclass_seen =645
    opt.batch_size = 512
    opt.dir = 'models\SUN\enc_sun1.pkl'
    opt.nz = 102
    opt.attSize = 102
    opt.ins_temp = 0.1
    opt.cls_temp = 0.01
...
schedulerG = lr.StepLR(optimizerG,step_size=38,gamma=0.2)
schedulerE = lr.StepLR(optimizerE,step_size=38,gamma=0.2)
